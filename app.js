...
let pink = document.querySelector('.pink').addEventListener('click', function() {
...
let yellow = document.querySelector('.yellow').addEventListener('click', function() {
...
let grey = document.querySelector('.white').addEventListener('click', function() {
